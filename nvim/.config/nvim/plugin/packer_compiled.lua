...
_G.packer_plugins = {
  ...
  ["feline.nvim"] = {
    loaded = true,
    path = "/Users/rafaelgarciadealba/.local/share/nvim/site/pack/packer/start/feline.nvim",
  ...
  ["trouble.nvim"] = {
    loaded = true,
    path = "/Users/rafaelgarciadealba/.local/share/nvim/site/pack/packer/start/trouble.nvim",
